...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-DSaYxEpo.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-D1ISD0DB.js"),
    import("./start-_llQ5b8Z.js"),
...
var ROUTER_BASEPATH = "sacred-revelation-quiz";
var SERVER_FN_BASE = "/sacred-revelation-quiz/_serverFn/";
